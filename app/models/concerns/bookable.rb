module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      store_bicycle.bookings.end_during(start_time, end_time),
      store_bicycle.bookings.start_during(start_time, end_time),
      store_bicycle.bookings.happening_during(start_time, end_time),
      store_bicycle.bookings.enveloping(start_time, end_time),
      store_bicycle.bookings.identical(start_time, end_time)
    ].flatten
